        ...
        <div class="flex justify-between h-16">
            ...
            @if (Auth::user())
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="profile-info flex items-center text-sm font-medium text-white transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                @if (Auth::user())
                    <div class="ml-3">
                        <div class="font-medium text-base text-white">{{ Auth::user()->user_name }}</div>
