...
<div class="container mt-3">
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('journeys.store', $id) }}">
        @csrf
        ...
        <div class="form-group mt-3">
            ...
            <input name="enjoyability" type="range" min="1" max="10" oninput="this.nextElementSibling.value = this.value" value="{{ old('enjoyability') ?? 5 }}">
        ...
        <div class="form-group mt-3">
            ...
            <input name="difficulty" type="range" min="1" max="10" oninput="this.nextElementSibling.value = this.value" value="{{ old('difficulty') ?? 5 }}">
